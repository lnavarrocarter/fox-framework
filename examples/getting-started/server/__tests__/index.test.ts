...
jest.mock('@/core/performance/middleware/metrics.middleware', () => ({
...
describe('Server Index', () => {
  beforeEach(() => {
    ...
    const { FoxFactory } = require('@/core/fox.factory');
  ...
  it('should register performance middleware', () => {
    ...
    const { performanceMiddleware } = require('@/core/performance/middleware/metrics.middleware');
