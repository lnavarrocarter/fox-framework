...
jest.mock('@/core/health/health-check', () => ({
...
jest.mock('@/core/performance/performance.factory', () => ({
  PerformanceFactory: {
...
describe.skip('Routes Index (New)', () => {
  ...
  it('should initialize health checker', () => {
    ...
    const { HealthChecker } = require('@/core/health/health-check');
  ...
  it('should initialize performance factory', () => {
    ...
    const { PerformanceFactory } = require('@/core/performance/performance.factory');
