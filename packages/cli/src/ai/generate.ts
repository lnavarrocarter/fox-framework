...
import { CodeGeneratorAgent } from '@foxframework/core/dist/tsfox/ai/agents/code-generator.agent';
import { 
    ControllerSpec, 
    MiddlewareSpec, 
    RouteSpec, 
    ModelSpec,
    AIAgentConfig 
} from '@foxframework/core/dist/tsfox/ai/interfaces/ai-agent.interface';
import fs from 'fs';
